    ...
    <main>
     <div className='search-header'>
      ...
      <FlexRow>
           ...
           {results===undefined? "":searchText.length<3? <div></div>:results?.length<1? <span className='search-div'></span> :<span className='search-div'>showing results <strong>{startIndex+1}</strong>:<strong>{Math.min(EndIndex,results.length)}</strong></span>}
      </FlexRow>
